...
Private Sub btnMethod1_Click()
    ...
    Me.DebitAmount.Enabled = False
    Me.CreditAmount.Enabled = False
    Me.DrCr.Enabled = False
    Me.IsDebit.Enabled = False
    RaiseEvent ProcessMethod(1)
End Sub

Private Sub btnMethod2_Click()
    Me.EntryAmount.Enabled = False
    Me.DebitAmount.Enabled = True
    Me.CreditAmount.Enabled = True
    Me.DrCr.Enabled = False
    Me.IsDebit.Enabled = False
...
Private Sub btnMethod3_Click()
    ...
    Me.DebitAmount.Enabled = False
    Me.CreditAmount.Enabled = False
    Me.DrCr.Enabled = True
    Me.IsDebit.Enabled = True
